...
class TestSignIn:
    ...
    baseURL = config_reader.get_application_url()
    number = config_reader.get_number()
    otp = config_reader.get_otp()
    invalid_number = config_reader.get_invalid_number()
    unregistered_number = config_reader.get_unregistered_number()
    invalid_verification_code = config_reader.invalid_verification_code()
    Title_website = config_reader.get_title()
    txt_sign_in = config_reader.text_sign_in()
    txt_number = config_reader.txt_phone_number()
    instruct_sign_in = config_reader.text_instruction_sig_in()
    instruct_phone = config_reader.txt_phone_instruction()
    txt_verify_code = config_reader.txt_verification_code()
    instruct_verify = config_reader.instruct_verify_code()
    alert_invalid = config_reader.alert_number_invalid()
    alert_unregistered = config_reader.alert_not_registered()
